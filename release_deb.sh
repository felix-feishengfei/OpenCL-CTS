...
DEB_PKG_VERSION=0.0.1
DEB_PKG_NAME=cts-opencl
...
# package to debian file
pushd build && cpack -V -G DEB -P ${DEB_PKG_NAME} -R ${DEB_PKG_VERSION} 2>&1 | tee ${TOP_DIR}/cpack.log && popd
